...
namespace Exportdataprocessing
{
    public partial class Form2 : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            textBox11.Text = urlcolindex.ToString();
            ...
            try
            {
                ...
                if (File.Exists(path))
                {
                    ...
                    textBox11.Text = ini.GetValue("urlcolindex", "colindex", urlcolindex.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        public static int urlcolindex = 1;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            urlcolindex = int.Parse(textBox11.Text);
            ...
            ini.WriteValue("urlcolindex", "colindex", urlcolindex.ToString());
