...
namespace 数据抓取
{
    public partial class Form1 : Form
    {
        ...
        private void 获取天猫连接(string strsource, CsvWriter csv)
        {
            ...
            var html = htmlDocument.DocumentNode;
            //标题
            var title = html.SelectSingleNode("//*[@id='J_DetailMeta']/div[1]/div[1]/div/div[1]/h1/a");
            csv.WriteField(title);
            string strtitle = title.GetAttributeValue("data-title");
            csv.WriteField(strtitle);
            ...
            csv.WriteField(sb.ToString().TrimEnd());
            var 快递 = html.SelectSingleNode("//*[@id='J_PostageToggleCont']/p/span").InnerText;
            Console.WriteLine(快递);
            csv.WriteField(快递);
        ...
        private void Btngetall_Click(object sender, EventArgs e)
        {
            ...
            HttpItem shttpitem = new HttpItem()
            {
                KeepAlive=true,
                Host = "s.taobao.com",
            ...
            var html= httphelper.GetHtml(shttpitem);
            string strsource = html.Html;
